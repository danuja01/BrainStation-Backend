...
import { tracedAsyncHandler } from '@sliit-foss/functions'; // Ensure this is a valid import
import {
    getUserPrediction,
    getUserData
} from '@/controllers/algorithm'; // Ensure the path to the controller is correct
